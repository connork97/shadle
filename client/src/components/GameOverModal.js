...
const GameOverModal = ({ colorOfTheDay, percentScore, previousUserGuesses, contrastColor, gameResult, rgbColorOfTheDay, opaqueRgbColorOfTheDay, gameOverModalIsOpen, closeGameOverModal }) => {
    ...
    return (
        <div className={styles.gameOverModalOverlay} style={overlayBackgroundColor}>
            <div className={styles.gameOverModalDiv}>
                <p className={styles.resultP}>You Scored: {percentScore}%</p>
                {/* <p className={styles.percentScoreP}><b>Score: </b> {percentScore()}%</p> */}
